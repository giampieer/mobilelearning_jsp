    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        case 2://GRABAR CURSO
        {
            ...
            try {
                ...
                obj.setIdcurso(cod);
                obj.setNombre(nom);
                String i=objCursoDao.grabarcurso(obj);
                json=new StringBuilder();
        ...
        case 3://MODIFICAR CURSO
        {
            ...
            try {
                ...
                obj.setIdcurso(cod);
                obj.setNombre(nom);
                String i=objCursoDao.modificarcurso(obj);
                json=new StringBuilder();
                json.append("[{\"estado\":\""+i+"\"}]");
                out.print(json.toString());
            } catch (Exception e) {
        ...
        case 4://Eliminar
        {
            ...
            try {
                Curso obj=new Curso();
                obj.setIdcurso(ide);
                String i=objCursoDao.eliminarcurso(obj);
                json=new StringBuilder();
                json.append("[{\"estado\":\""+i+"\"}]");
                out.print(json.toString());
                } catch (Exception e) {
        ...
        case 6: //CAPTURAR DATOS
        {
            ...
            int ide=Integer.parseInt(request.getParameter("cod"));
            try {
                objeto.setIdcurso(ide);
                Curso obj=objCursoDao.cargarcurso(objeto);
                json=new StringBuilder();
                json.append("[{\"Id\":\""+obj.getIdcurso()+"\", \"Nombre\":"+obj.getNombre()+"}]\n");
                out.print(json.toString());
            } catch (Exception e) {
            }
            break;
